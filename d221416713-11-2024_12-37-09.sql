...
CREATE TABLE `companyname` (
  `companynameid` int(11) NOT NULL AUTO_INCREMENT,
  `companyname` varchar(30) DEFAULT NULL,
  `gstinvoice` int(11) DEFAULT NULL,
...
INSERT INTO `companyname` VALUES (1,'clickzone',4534532);
...
CREATE TABLE `coustomer` (
  `coustomerid` int(11) NOT NULL AUTO_INCREMENT,
  `coustomername` varchar(30) DEFAULT NULL,
  `coustomercity` varchar(30) DEFAULT NULL,
  `coustomercountry` varchar(30) DEFAULT NULL,
  `coustomermobile` char(10) DEFAULT NULL,
  `coustomercategory` varchar(10) DEFAULT NULL,
  `coustomerrating` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`coustomerid`)
...
INSERT INTO `coustomer` VALUES (1,'Devyansh','delhi','india','9897282762','for person','average'),(2,'methu','nainital','india','9897277778','for person','good'),(3,'pawan','mumbai','india','677685778','for person','good');
...
INSERT INTO `product` VALUES (1,'nikon d7000','dslr',3,'this camera is good for professional photographer for weddings and other occaison','nikon','4years'),(2,'canon c6','dslr',2,'good for potrait','canon','2years'),(3,'sony m6','dslr',2,'good for potrait','sony','2years');
...
INSERT INTO `productcategory` VALUES (1,'dslr'),(2,'slr'),(3,'movie camera'),(4,'tripod'),(5,'other accesories');
...
CREATE TABLE `purchase` (
  ...
  `suppliername` varchar(30) DEFAULT NULL,
  `suppliercity` varchar(30) DEFAULT NULL,
  `productcategory` varchar(30) DEFAULT NULL,
  `unitpurchase` int(11) DEFAULT NULL,
...
INSERT INTO `purchase` VALUES (1,'c2','nikon d7000',1,1,'sanju','delhi','dslr',12,134400,'2024-09-28','12','120000.0','10000','14400.0'),(2,'c3','canon c6',2,2,'manju','mathura','dslr',12,134400,'2024-09-28','12','120000.0','10000','14400.0'),(3,'1234','sony m6',3,3,'seenu','mumbai','dslr',13,174720,'2024-09-28','12','156000.0','12000','18720.0'),(4,'cr1','canon c6',2,2,'manju','mathura','dslr',10,134400,'2024-09-28','12','120000.0','12000','14400.0');
...
CREATE TABLE `purchase_return` (
  ...
  `productunit` int(11) DEFAULT NULL,
  `transdate` date DEFAULT NULL,
  `productreview` varchar(30) DEFAULT NULL,
  `supplierreview` varchar(10) DEFAULT NULL,
...
--
-- Table structure for table `replacementrefund`
--

DROP TABLE IF EXISTS `replacementrefund`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `replacementrefund` (
  `replacementrefundid` int(11) NOT NULL AUTO_INCREMENT,
  `productcode` varchar(30) DEFAULT NULL,
  `productname` varchar(30) DEFAULT NULL,
  `coustomerid` int(11) DEFAULT NULL,
  `coustomername` varchar(20) DEFAULT NULL,
  `productcategory` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`replacementrefundid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `replacementrefund`
--

LOCK TABLES `replacementrefund` WRITE;
/*!40000 ALTER TABLE `replacementrefund` DISABLE KEYS */;
INSERT INTO `replacementrefund` VALUES (1,'123','d7000',123,'shiv','dslr');
/*!40000 ALTER TABLE `replacementrefund` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sale` (
  ...
  `totalamount` varchar(10) DEFAULT NULL,
  `gstamount` varchar(10) DEFAULT NULL,
  `netamount` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`saleid`)
...
INSERT INTO `sale` VALUES (1,'12345','nikon d7000',1,1,'Devyansh','dslr',12,'4years','2024-09-28',18000,12,'216000.0','2160.0','218160.0'),(2,'1267','nikon d7000',1,1,'Devyansh','dslr',2,'4years','2024-09-28',19000,12,'38000.0','2280.0','40280.0'),(3,'ce1','nikon d7000',1,1,'Devyansh','dslr',2,'4years','2024-09-28',17800,12,'35600.0','2136.0','37736.0'),(4,'666878','nikon d7000',1,1,'Devyansh','dslr',12,'4years','2024-09-28',19000,12,'228000.0','2280.0','230280.0'),(5,'8070','canon c6',2,2,'methu','dslr',12,'2years','2024-10-04',20000,12,'240000.0','2400.0','242400.0'),(6,'0988','sony m6',3,3,'pawan','dslr',14,'2years','2024-10-04',21000,12,'294000.0','2520.0','296520.0'),(7,'485','nikon d7000',1,1,'Devyansh','dslr',7,'4years','2024-10-16',18000,12,'126000.0','2160.0','128160.0'),(8,'568767857','canon c6',2,2,'methu','dslr',11,'2years','2024-10-30',18000,12,'198000.0','2160.0','200160.0'),(9,'12234','canon c6',2,2,'methu','dslr',9,'2years','2024-10-07',19000,12,'171000.0','2280.0','173280.0'),(10,'789078','sony m6',3,3,'pawan','dslr',6,'2years','2024-10-11',19990,12,'119940.0','2398.8','122338.8');
...
CREATE TABLE `sale_return` (
  `salereturnid` int(11) NOT NULL AUTO_INCREMENT,
  `netrefundamount` int(11) DEFAULT NULL,
  `productname` varchar(30) DEFAULT NULL,
  `coustomercode` int(11) DEFAULT NULL,
  `coustomername` varchar(30) DEFAULT NULL,
  `productunit` int(11) DEFAULT NULL,
  `transdate` date DEFAULT NULL,
  `warrantyperiod` varchar(30) DEFAULT NULL,
  `underwarranty` varchar(3) DEFAULT NULL,
...
CREATE TABLE `supplier` (
  ...
  `suppliercity` varchar(30) DEFAULT NULL,
  `suppliercompany` varchar(30) DEFAULT NULL,
  `suppliercategory` varchar(30) DEFAULT NULL,
  `suppliercontact` varchar(11) DEFAULT NULL,
  `supplierrating` varchar(10) DEFAULT NULL,
...
INSERT INTO `supplier` VALUES (1,'sanju','India','delhi','nikon','wholeseller','9896754902','good'),(2,'manju','india','mathura','canon','retailer','9897905678','good'),(3,'seenu','india','mumbai','sony','retailer','8987905678','good');
...
-- Dump completed on 2024-11-13 12:37:12
